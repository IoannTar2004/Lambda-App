...
class CreateFunctionDTO(BaseModel):
    ...
    function_name: str = Field(min_length=3, max_length=64, description='name of function')
    project_name: str = Field(min_length=3, max_length=32, description='name of project')
